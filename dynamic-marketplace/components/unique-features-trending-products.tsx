...
export default async function UniqueFeaturesTrendingProducts() {
...
if (!uniqueFeaturesData || uniqueFeaturesData.length === 0) {
  return console.log('no data available');
      ...
      return (
      <div id="marketing-panel-main-div" className="flex gap-[5px] w-[100%] bg-[#F1F0FF] justify-center relative items-center h-[40vh] sm:h-[60vh]" key={uniqueFeaturesData[0].id}>
      <Image src={urlFor(uniqueFeaturesData[0].image).url()} alt="marketing" width={400} height={400} layout='responsive' className="max-w-[400px]" />
      <div className='ml-[20px]'>
        ...
        <ul className='hidden text-[#ACABC3] leading-6 md:inline-block'>
          <li><div id="bullets" className='bg-red-600 w-[10px] h-[10px] rounded-full' /> <p className='text-[12px]'>{uniqueFeaturesData[0].descriptionPoint1}</p></li>
          <li><div className='bg-green-600 w-[10px] h-[10px] rounded-full'></div> <p className='text-[12px]'>{uniqueFeaturesData[0].descriptionPoint3}</p></li>
          <li><div className='bg-blue-600 w-[10px] h-[10px] rounded-full'></div> <p className='text-[12px]'>{uniqueFeaturesData[0].descriptionPoint3}</p></li>
        </ul>
        ...
        <ul className='flex gap-[10px] items-center'>
          ...
          <li className='flex flex-col items-start justify-center'>
            ...
            <p className={`${josefinSans.className} text-[12px] text-[#151875]`}>${uniqueFeaturesData[0].price}</p>
          </li>
        </ul>
